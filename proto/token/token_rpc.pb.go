...
func (m *UserBindList) Reset()         { *m = UserBindList{} }
func (m *UserBindList) String() string { return proto.CompactTextString(m) }
func (*UserBindList) ProtoMessage()    {}
func (*UserBindList) Descriptor() ([]byte, []int) {
	return fileDescriptor_647c9577c1f98294, []int{1}
}

func (m *UserBindList) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UserBindList.Unmarshal(m, b)
}
func (m *UserBindList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UserBindList.Marshal(b, m, deterministic)
}
func (m *UserBindList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UserBindList.Merge(m, src)
}
func (m *UserBindList) XXX_Size() int {
	return xxx_messageInfo_UserBindList.Size(m)
}
func (m *UserBindList) XXX_DiscardUnknown() {
	xxx_messageInfo_UserBindList.DiscardUnknown(m)
}

var xxx_messageInfo_UserBindList proto.InternalMessageInfo

func (m *UserBindList) GetUserId() uint64 {
	if m != nil {
		return m.UserId
	}
	return 0
...
func (m *UserBindList) GetBindToken() string {
	if m != nil {
		return m.BindToken
	}
	return ""
...
type TokenResponse struct {
	...
	BindList             []*UserBindList `protobuf:"bytes,2,rep,name=bind_list,json=bindList,proto3" json:"bind_list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*TokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_647c9577c1f98294, []int{2}
}
...
func (m *TokenResponse) GetBindList() []*UserBindList {
	if m != nil {
		return m.BindList
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UserBindList)(nil), "token.UserBindList")
...
var fileDescriptor_647c9577c1f98294 = []byte{
	...
	,
}
